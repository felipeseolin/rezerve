...
(
    HOR_ID varchar(2) NOT NULL,
    HOR_INICIO time NOT NULL,
    HOR_FIM time NOT NULL,
    CONSTRAINT horario_pk PRIMARY KEY (HOR_ID)
);
insert into horario
    (HOR_ID, HOR_INICIO, HOR_FIM)
values
    ('M1', '07:30:00', '08:20:00'),
    ('M2', '08:20:00', '09:10:00'),
    ('M3', '09:10:00', '10:00:00'),
    ('M4', '10:20:00', '11:10:00'),
    ('M5', '11:10:00', '12:00:00'),
    ('M6', '12:00:00', '12:50:00'),
    ('T1', '13:00:00', '13:50:00'),
    ('T2', '13:50:00', '14:40:00'),
    ('T3', '14:40:00', '15:30:00'),
    ('T4', '15:50:00', '16:40:00'),
    ('T5', '16:40:00', '17:30:00'),
    ('T6', '17:50:00', '18:40:00'),
    ('N1', '18:40:00', '19:30:00'),
    ('N2', '19:30:00', '20:20:00'),
    ('N3', '20:20:00', '21:10:00'),
    ('N4', '21:20:00', '22:10:00'),
    ('N5', '22:10:00', '23:00:00');
...
(
    RESHOR_ID SERIAL NOT NULL,
    RESER_ID int NOT NULL,
    HOR_ID varchar(2) NOT NULL,
    CONSTRAINT reserva_horario_pk PRIMARY KEY (RESHOR_ID)
);
...
-- foreign keys
-- Reference: reserva_horario_horario (table: reserva_horario)
ALTER TABLE reserva_horario ADD CONSTRAINT reserva_horario_horario
    FOREIGN KEY (HOR_ID)
...
-- Reference: reserva_horario_reserva (table: reserva_horario)
ALTER TABLE reserva_horario ADD CONSTRAINT reserva_horario_reserva
    FOREIGN KEY (RESER_ID)
    REFERENCES reserva (RESER_ID)
NOT DEFERRABLE 
    INITIALLY IMMEDIATE
;
...
-- Fuction to select all HORARIO
CREATE OR REPLACE FUNCTION listaHorarios
() RETURNS setof horario AS
'select * from HORARIO order by HOR_INICIO asc;'
LANGUAGE 'sql';

-- Fuction to select all RESERVA_HORARIO
CREATE OR REPLACE FUNCTION listaReservasHorarios
() RETURNS setof reserva_horario AS
'select * from RESERVA_HORARIO order by RESHOR_ID desc;'
LANGUAGE 'sql';
