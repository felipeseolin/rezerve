...
public class SalaDAO {
    ...
    /**
     * Método responsável por listar todos os registros de sala com filtros
     *
     * @return
     */
    protected static ArrayList<Sala> selectAllFilter(ArrayList filtros) {
        PreparedStatement pstdados = null;
        ResultSet rs = null;
        ArrayList<Sala> retornoLista = null;
        BDController bd = new BDController();
        ...
        try {
            ...
            if (filtros == null) {
                ...
                int numero = (int) iterator.next();
                int qntCadeiras = (int) iterator.next();
                int qntComputadores = (int) iterator.next();
